...
import { Badge } from '@legalmeet/ui';
import { Button } from '@legalmeet/ui';
import { Card } from '@legalmeet/ui';
...
const defaultGalleryImages: GalleryImage[] = [
  ...
  {
    id: 6,
    url: 'https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=500',
...
export function GalleryGridBlock({
  ...
  description = 'Explore our collection of stunning visuals and creative work',
  badgeText = 'Gallery',
